...
class CommentDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Comment
    template_name = 'meet/comment_delete.html'
...
class ProfileEditView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = UserProfile
    fields = ['name', 'bio', 'birth_date', 'location', 'interest', 'picture']
    template_name = 'meet/profile_edit.html'
...
class ListThreads(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'meet/inbox.html', context)
...
class CreateThread(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'meet/create_thread.html', context)
...
class ThreadView(View):
    def get(self, request, pk, *args, **kwargs):
        ...
        return render(request, 'meet/thread.html', context)
